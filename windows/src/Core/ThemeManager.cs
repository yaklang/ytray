...
namespace YTray.Core
{
    ...
    public static class ThemeManager
    {
        ...
        private static readonly IReadOnlyDictionary<string, string> DarkPalette =
            new Dictionary<string, string>
            {
                ["BrandPaleColor"] = "#56351F",
                ["AppBackgroundColor"] = "#15181A",
                ["TitleBarColor"] = "#16191B",
                ["SidebarColor"] = "#191C1F",
                ["SurfaceColor"] = "#1A1D20",
                ["SurfaceRaisedColor"] = "#202326",
                ["SurfaceMutedColor"] = "#1D2023",
                ["InputColor"] = "#202326",
                ["TextPrimaryColor"] = "#EEEDEA",
                ["TextSecondaryColor"] = "#B1B1B4",
                ["TextTertiaryColor"] = "#7F8287",
                ["HairlineColor"] = "#34383B",
                ["WindowBorderColor"] = "#3A3E41",
                ["HoverColor"] = "#25292C",
                ["PressedColor"] = "#2D3134",
